...
public class third {
	...
	public static void main(String[] args) {
		student s=new student("pktc","computer","shivam");
		s.display();
	}
...
class student extends department{
	...
	public student(String College_name, String department_name, String Student_name) {
		super(College_name, department_name);
